...
They grade what a `/watch` run produced: that every timestamp a note cites
exists in the run, that a claim tagged ON-SCREEN was actually on screen, that a
declared review lane really emitted a report, and that a citation still says
what it said when it was resolved.
